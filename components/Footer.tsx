        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-muted text-sm leading-relaxed max-w-xs">
              Custom Software Developer for Growing Businesses. Building management systems,
          ...
          {/* Center: Nav Links */}
          <div>
            <h4 className="font-semibold text-text text-sm mb-4 uppercase tracking-widest">
              Navigation
            </h4>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="text-muted hover:text-accent text-sm transition-colors duration-200 flex items-center gap-2"
              >
